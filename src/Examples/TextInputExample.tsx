    ...
    <TextInputAvoidingView>
      ...
      >
        ...
        <TextInput
          ...
          placeholder="Type something"
          value={flatDenseText}
          onChangeText={flatDenseText => inputActionHandler('flatDenseText', flatDenseText)}
          left={<TextInput.Affix text="#" />}
        />
        <TextInput
          style={styles.inputContainerStyle}
        ...
        <TextInput
          ...
          placeholder="Type something"
          value={flatMultiline}
          onChangeText={flatMultiline => inputActionHandler('flatMultiline', flatMultiline)}
        />
        <TextInput
          ...
          placeholder="Type something"
          value={flatTextArea}
          onChangeText={flatTextArea => inputActionHandler('flatTextArea', flatTextArea)}
        />
        <TextInput disabled style={styles.inputContainerStyle} label="Disabled flat input" />
        <TextInput
          mode="outlined"
          style={styles.inputContainerStyle}
          ...
          placeholder="Type something"
          value={outlinedText}
          onChangeText={outlinedText => inputActionHandler('outlinedText', outlinedText)}
          left={
            <TextInput.Icon
              name="heart"
        ...
        <TextInput
          ...
          value={outlinedDense}
          onChangeText={outlinedDense => inputActionHandler('outlinedDense', outlinedDense)}
        />
        <TextInput
          mode="outlined"
          style={styles.inputContainerStyle}
        ...
        <View style={styles.inputContainerStyle}>
          <TextInput
            ...
            onChangeText={maxLengthName => inputActionHandler('maxLengthName', maxLengthName)}
        ...
        <View style={styles.inputContainerStyle}>
          <TextInput
            ...
            onChangeText={nameNoPadding => inputActionHandler('nameNoPadding', nameNoPadding)}
          />
          <HelperText type="error" padding="none" visible={!_isUsernameValid(nameNoPadding)}>
            Error: Only letters are allowed
          </HelperText>
        </View>
      </ScrollView>
