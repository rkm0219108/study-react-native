...
const MenuExample = ({ navigation }: Props) => {
  ...
  const [contextualMenuCoord, setContextualMenuCoor] = React.useState<ContextualMenuCoord>({
    x: 0,
    y: 0,
  });
    ...
    <View style={styles.screen}>
      <Appbar.Header>
        ...
        <Menu
          ...
          anchor={<Appbar.Action icon={MORE_ICON} color="white" onPress={_toggleMenu('menu1')} />}
        >
      ...
      <View style={[styles.container, { backgroundColor: background }]}>
        ...
        <List.Section style={styles.list} title="Contextual menu">
          <TouchableRipple onPress={() => {}} onLongPress={_handleLongPress}>
            <List.Item title="List item" description="Long press me to open contextual menu" />
          </TouchableRipple>
        </List.Section>
      </View>
    </View>
