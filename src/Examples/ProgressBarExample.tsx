...
const ProgressBarExample = () => {
  ...
  return (
    <View style={[styles.container, { backgroundColor: background }]}>
      ...
      <Button onPress={() => setProgress(Math.random())}>Random progress</Button>
      ...
      <View style={styles.row}>
        ...
        <ProgressBar progress={progress} visible={visible} color={Colors.red800} />
      </View>
      ...
      <View style={styles.row}>
        ...
        <ProgressBar progress={progress} visible={visible} style={{ height: 20 }} />
      </View>
    </View>
  );
};
