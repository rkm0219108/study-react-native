    ...
    <ScrollView style={[styles.container, { backgroundColor: colors.background }]}>
      <List.Section title="Text button">
        <View style={styles.row}>
          ...
          <Button color={colors.accent} onPress={() => {}} style={styles.button}>
            Custom
          </Button>
      ...
      <List.Section title="Outlined button">
        <View style={styles.row}>
          ...
          <Button mode="outlined" color={colors.accent} onPress={() => {}} style={styles.button}>
            Custom
          </Button>
      ...
      <List.Section title="Contained button">
        <View style={styles.row}>
          ...
          <Button mode="contained" color={colors.accent} onPress={() => {}} style={styles.button}>
            Custom
          </Button>
