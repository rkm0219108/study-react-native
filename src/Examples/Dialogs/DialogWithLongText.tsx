...
const DialogWithLongText = ({ visible, close }: { visible: boolean; close: () => void }) => (
  <Portal>
    <Dialog
      onDismiss={close}
      visible={visible}
      ...
      <Dialog.ScrollArea style={{ paddingHorizontal: 0 }}>
        <ScrollView contentContainerStyle={{ paddingHorizontal: 24 }}>
          <Paragraph>
            ...
            motion. The material is grounded in tactile reality, inspired by the study of paper and
            ink, yet technologically advanced and open to imagination and magic.
            {'\n'}
            {'\n'}
