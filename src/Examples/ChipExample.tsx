      ...
      <ScrollView style={[styles.container, { backgroundColor: colors.surface }]}>
        <List.Section title="Flat chip">
          <View style={styles.row}>
            <Chip mode="outlined" selected onPress={() => {}} style={styles.chip}>
              Simple
            </Chip>
            <Chip
              onPress={() => {}}
            ...
            <Chip icon="heart" onPress={() => {}} onClose={() => {}} style={styles.chip}>
              Icon
            </Chip>
            <Chip
        ...
        <List.Section title="Outlined chip">
          <View style={styles.row}>
            ...
            <Chip mode="outlined" onPress={() => {}} onClose={() => {}} style={styles.chip}>
              Close button
            </Chip>
            <Chip
              mode="outlined"
            ...
            <Chip disabled mode="outlined" icon="heart" onClose={() => {}} style={styles.chip}>
              Icon (disabled)
            </Chip>
            <Chip
              disabled
          ...
          <View style={styles.row}>
            ...
            <Chip
              ...
              style={[
                styles.chip,
                {
                  backgroundColor: color(colors.primary).alpha(0.2).rgb().string(),
                },
              ]}
            ...
            <Chip onPress={() => {}} style={styles.chip} selectedColor={colors.primary}>
            ...
            <Chip onPress={() => {}} style={styles.chip} textStyle={styles.tiny}>
              With custom size
            </Chip>
            <Chip
              onPress={() => {}}
            ...
            >
              With a very big text: React Native Paper is a high-quality, standard-compliant
              Material Design library that has you covered in all major use-cases.
            </Chip>
          </View>
        </List.Section>
      </ScrollView>
